...
public class JobSearch {
    ...
    private static Stream<JobPosition> executeRequest(Map<String, Object> paramns){
        APIJobs api = buildAPI(APIJobs.class, "https://dummyapi.io/explorer"); //https://dummyapi.io/explorer https://jobs.github.com

        return Stream.of(paramns)
                .map(api::jobs)
